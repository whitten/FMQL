FMQLSSAM; Caregraf - FMQL Schema Enhancement for Terminologies ; Jul, 2013
 ...
 ;
 ; TODO: 
 ; - make model/suite dependent (VA, RPMS, CHCS ... ie/ one for each)
 ; - change to be dictionary driven ie. from, to, byfield. Key for scale (can move to file later)
 ; - VA: NDC (11 form)
...
RESOLVE(FILENUM,IEN,DEFLABEL,SAMEAS) ;
 ...
 I $D(^PSDFDB) D RESOLVE^FMQLSMAC(IEN,.SAMEAS) Q ; O Vocabs
