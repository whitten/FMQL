...
BLDFDINF(FLINF,FIELD,FDINF) ;
 ...
 I $D(FLINF("FDPREDS",FILE_";"_FIELD)) S FDINF("PRED")=FLINF("FDPREDS",FILE_";"_FIELD) S ^TMP("FMQL",$J,"REUSED",FDINF("PRED"))=$S($D(^TMP("FMQL",$J,"REUSED",FDINF("PRED"))):^TMP("FMQL",$J,"REUSED",FDINF("PRED"))+1,1:1)
